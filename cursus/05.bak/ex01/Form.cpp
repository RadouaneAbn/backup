...
{
	if (obj.getIsSigned())
		o << "Form \033[33m" << obj.getName() << "\033[0m is signed. Sign grade: " << obj.getSignGrade() << ", Exec grade: " << obj.getExecGrade() << ".";
	else
		o << "Form \033[33m" << obj.getName() << "\033[0m is not signed. Sign grade: " << obj.getSignGrade() << ", Exec grade: " << obj.getExecGrade() << ".";
	return (o);
}